...
*/
  ...
  // adding test for Friday
  describe("system answer from database for Friday", () => {
    runTest([
      { speaker: "sys", message: "Hello! You can ask me anything!" },
      { speaker: "usr", message: "Where is the lecture?" },
  ...
  // adding test for Thursday (/ Tuesday)
  describe("system answer from database for Thursday", () => {
    runTest([
      { speaker: "sys", message: "Hello! You can ask me anything!" },
      { speaker: "usr", message: "Where is the lecture?" },
      { speaker: "sys", message: "Which day?" },
